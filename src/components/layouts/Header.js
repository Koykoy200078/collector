...
export default function () {
  return (
    <View className="w-screen h-fit items-start justify-center bg-[#003D90]">
      ...
      <View className="flex-row p-2 w-full items-center justify-center">
        <View className="w-[100%] justify-evenly items-center rounded bg-yellow-400 p-2">
          <TouchableOpacity>
            <Image
              source={{
